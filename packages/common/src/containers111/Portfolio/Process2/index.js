...
import { PROCESS_STEPS, SERVICE_LIST } from '../../../data/Portfolio/data2';
      ...
      <Container noGutter mobileGutter width="1200px">
        ...
        <Box {...learningRow}>
          <Box {...learningContentArea}>
            ...
            <Text
              {...learningDescription}
              content="Hold TPROP in your Prop Wallet, On the Token Investment Portal (TIP) or on PropX- Our Property Token Exchange."
            />
            <Box {...buttonWrapper}>
              <Text content="Tokenize Your Project ?" {...buttonLabelStyle} />
              <ButtonWrapper>
                <Button
                  title="Buy TPROP"
