...
ControlSection.defaultProps = {
  ...
  description: {
    content:
      'TPROP affords the investor opportunity to invest in various projects across the globe. At the same time it allows property owners to tap into their equity or help fund new development.',
    fontSize: '16px',
    fontWeight: '400',
    color: '#525f7f',
    lineHeight: '28px',
