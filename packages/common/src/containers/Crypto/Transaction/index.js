...
TransactionsHistory.defaultProps = {
  ...
  title: {
    content: 'Our wallet is built to give you the best experience',
  ...
  description: {
    content:
      'Always have access to your portfolio with up to the minute performance.',
    fontSize: '16px',
    fontWeight: '400',
    color: '#525f7f',
    lineHeight: '28px',
