        ...
        <Box className="row" {...row}>
          <Box className="col" {...col}>
            <FeatureBlock
              title={
                <Heading
                  content="Welcome to Token Prop - Token Investment Portal"
                  {...title}
                />
              }
              description={
                <Text
                  content="Unprecedented Real Estate Investment Opportunities on the Blockchain"
                  {...description}
                />
              }
              smallText={
                <Text
                  content="Fractional Property Ownership for Investors...Innovative Liquidity Solutions for Owners"
                  {...smallText}
                />
              }
            />
            <EmailInputWrapper>
              ...
              <Link href="#fare_section">
                <a>
                  <Button title="Register Interest" {...button} />
                </a>
              </Link>
            </EmailInputWrapper>
...
BannerSection.defaultProps = {
  ...
  smallText: {
    fontSize: ['10px', '14px', '16px', '16px', '18px'],
    color: '#fff',
    lineHeight: '30px',
    mb: '80px',
    maxWidth: '550px',
