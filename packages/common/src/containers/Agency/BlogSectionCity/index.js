...
const BlogSection = ({
  ...
  return (
    <BlogSectionWrapper id="blogSection">
      <Container>
        <Box {...sectionHeader}>
          <Text content="CITY NAME" {...sectionSubTitle} />
          <Heading
            content="Our Top Markets"
            {...sectionTitle}
          />
        </Box>
        <Box className="row" {...row}>
          {data.blog.map((post, index) => (
            <FeatureBlock
              ...
              blogAddr={
                <Link href={post.address} {...blogAddr}>
                  {post.address}
                </Link>
              }
              blogMin={<Text content={post.min} {...blogMin} />}
            />
          ))}
        </Box>
      </Container>
...
BlogSection.propTypes = {
  ...
  blogAddr: PropTypes.object,
  blogMin: PropTypes.object,
};
