...
import PreviewImage from '../../../assets/image/agency/preview-image.jpg';
...
const VideoSection = ({
  ...
  return (
    <VideoSectionWrapper id="videoSection">
      <Container>
        <Box {...sectionHeader}>
          <Text content="PROPX Exchange" {...sectionSubTitle} />
          <Heading content="A Dedicated Exchange Platform for Property Tokens" {...sectionTitle} />
        </Box>
